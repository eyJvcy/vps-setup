...
SCRIPTS=(
    ...
    "scripts/3b-protect-ssh.sh:Protection SSH au démarrage"
...
echo "  ✓ Protection SSH au démarrage activée"
...
echo "  3. Testez un reboot pour vérifier la persistance"
echo "  4. Générez la config SSH locale: ./utils/generate-ssh-config.sh"
echo ""
